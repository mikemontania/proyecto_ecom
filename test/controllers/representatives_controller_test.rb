...
class RepresentativesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create representative" do
    assert_difference('Representative.count') do
      post representatives_url, params: { representative: { address: @representative.address, email: @representative.email, latitude: @representative.latitude, longitude: @representative.longitude, name: @representative.name, phone: @representative.phone, website: @representative.website } }
    end
  ...
  test "should update representative" do
    patch representative_url(@representative), params: { representative: { address: @representative.address, email: @representative.email, latitude: @representative.latitude, longitude: @representative.longitude, name: @representative.name, phone: @representative.phone, website: @representative.website } }
