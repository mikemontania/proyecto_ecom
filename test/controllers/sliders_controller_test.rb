...
class SlidersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slider" do
    assert_difference('Slider.count') do
      post sliders_url, params: { slider: { active: @slider.active, link: @slider.link, name: @slider.name, order: @slider.order } }
    end
  ...
  test "should update slider" do
    patch slider_url(@slider), params: { slider: { active: @slider.active, link: @slider.link, name: @slider.name, order: @slider.order } }
